...
COPY --from=builder /go/src/github.com/Soluto/golang-docker-healthcheck/server ./server
COPY --from=builder /go/src/github.com/Soluto/golang-docker-healthcheck/health-check ./healthcheck
